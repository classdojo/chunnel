  ...
  Client = (function(_super) {
    ...
    */
    ...
    Client.prototype.close = function() {
      this._chunnelConnection.connection.removeListener("end", this._reconnect);
      this._chunnelConnection.connection.removeListener("error", this._reconnect);
      return this._chunnelConnection.close();
    };
    ...
    */
    ...
    Client.prototype._onGetConnection = function() {
      ...
      return c2.on("error", function(err) {
